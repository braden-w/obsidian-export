...
import { getMarkdownFilesData } from "../helpers/fileUtils.ts"
...
export async function generateSummary() {
  const journalDirectory =
    "/Users/braden/Library/Mobile Documents/iCloud~md~obsidian/Documents/Obsidian/journals"
  const markdownFiles = await getMarkdownFilesData(contentDirectory)
